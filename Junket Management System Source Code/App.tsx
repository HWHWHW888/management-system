  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'customers' && (isAdmin || isAgent || isStaff) && <CustomerManagement user={currentUser} />}
        {activeTab === 'agents' && (isAdmin || isStaff) && <AgentManagement user={currentUser} />}
        {activeTab === 'staff' && isAdmin && <StaffManagement user={currentUser} />}
        {activeTab === 'checkinout' && isStaff && <StaffPortal user={currentUser} />}
        {activeTab === 'projects' && (isAdmin || isAgent) && <ProjectManagement user={currentUser} />}
