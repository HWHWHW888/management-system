 ...
 */
router.get('/quick-stats', authenticateUser, requirePermission('reports:read'), async (req, res) => {
    try {
 ...
 */
router.get('/agent/:agentId', authenticateUser, requirePermission('reports:read'), async (req, res) => {
    try {
